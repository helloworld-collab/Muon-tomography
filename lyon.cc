...
void lyon() {
    // Open file
    TFile *f = new TFile("DAT000003lyon.root");
    ...
    TCanvas *cevent = new TCanvas("cevent", "Event level distributions lyon", 800, 600);
    cevent->Divide(2,2);
    cevent->cd(1); 
    ...
    heprim->Draw();
    cevent->SaveAs("event_distributions_lyon.jpeg");
    ...
    TH1F* hmu_costheta = new TH1F("hmu_costheta", "Muon cos(Theta) Distribution lyon", 100, 0, 1);
    TH1F* hmu_energy = new TH1F("hmu_energy", "Muon Energy Distribution lyon", 100, 0, 30); // energy [GeV]
    ...
    TCanvas *cparticle = new TCanvas("cparticle", "Particle level distributions lyon", 800, 600);
    ...
    cparticle->SaveAs("particle_distributions_lyon.jpeg");
}
