...
void chyulu() {
    // Open file
    TFile *f = new TFile("DAT000003chyulu.root");
    ...
    TCanvas *cevent = new TCanvas("cevent", "Event level distributions chyulu", 800, 600);
    cevent->Divide(2,2);
    cevent->cd(1); 
    ...
    heprim->Draw();
    cevent->SaveAs("event_distributions_chyulu.jpeg");
    ...
    TH1F* hmu_costheta = new TH1F("hmu_costheta", "Muon cos(Theta) Distribution chyulu", 100, 0, 1);
    //TH1F* hmu_energy = new TH1F("hmu_energy", "Muon Energy Distribution chyulu", 100, 0, 30); // energy [GeV]
    ...
    TCanvas *cparticle = new TCanvas("cparticle", "Particle level distributions chyulu", 800, 600);
    ...
    cparticle->SaveAs("particle_distributions_costhetachyulu.jpeg");
}
